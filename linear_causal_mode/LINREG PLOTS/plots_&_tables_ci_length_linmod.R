...
b0_1.5 = ggplot(psi_sd_dat, aes(x = alpha - 0.5, y = u0_1.5 - l0_1.5, group = alpha)) +  
...
b0.5_1.5 = ggplot(psi_sd_dat, aes(x = alpha, y = u0.5_1.5 - l0.5_1.5, group = alpha)) +  
  geom_boxplot(width = 0.01, fill = "grey") +
  xlab(expression(alpha)) + 
  ylab("95% level CIs length")           +
...
psi_sd_dat$ln0.5_1.5 = psi_sd_dat$u0.5_1.5 - psi_sd_dat$l0.5_1.5
psi_sd_dat$ln0_1.5   = psi_sd_dat$u0_1.5   - psi_sd_dat$l0_1.5

library(xtable)

df_alpha_0 = round( rbind(tapply(psi_sd_dat$ln0_0, INDEX = psi_sd_dat$alpha - 0.5, FUN = mean), 
                    tapply(psi_sd_dat$ln0_1.5, INDEX = psi_sd_dat$alpha - 0.5, FUN = mean)), 3)

df_alpha_0.5 = round(rbind(tapply(psi_sd_dat$ln0.5_0, INDEX = psi_sd_dat$alpha, FUN = mean), 
                     tapply(psi_sd_dat$ln0.5_1.5, INDEX = psi_sd_dat$alpha, FUN = mean)), 3)
